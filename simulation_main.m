...
%rng(921111)
dset = 1;
n1m  = [3 3];   % governs initial cell number
        ...
        for n3 = n3m(1):n3m(2)                      
            for n4 = n4m(1):n4m(2)                  
                for n5 = n5m(1):n5m(2)              
                    ...
                    l0 = [0.000 0.020 0.050]/3600;        % base division rate
                    l1 = [0.000 0.200 0.500]/3600;        % allee parameter
                    om = [0.000 0.005 0.070]/3600;        % base death rate
                    lambda0 = l0(n3);
                    lambda1 = l1(n3);
                    omega   = om(n3);
